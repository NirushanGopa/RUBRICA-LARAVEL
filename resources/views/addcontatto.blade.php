    ...
    <div style="margin-left:150px; margin-right:150px; margin-top: 50px;">
        <div style="background-color:#DDD; border: 1px solid #000000;">
            <div class="container-fluid; border: 1px solid #000000;">
                <h4 class="display-3" style="font-family:verdana">Nuovo contatto<span class="blink_me"><b>:</b></span></h4>
            </div>
        </div>
        <br>
        ...
        <div style="width: 100%;" style="white-space: nowrap;">
            <form id="imSearch_1" method="POST" action="{{ route('post.rubrica') }}">
                @csrf
                <table class="table table-striped  table-hover" width="100%">
                    ...
                    <thead style="background-color:#DDD" >
                        ...
                        <tr>
                            ...
                            <th scope="col"><input type="tel" name="cellulare" required></th>
                        </tr>
                        <tr>
                            <th scope="col">Email</th>
                            <th scope="col"><input type="email" name="email" required></th>
                        </tr>
                        <tr>
                            <th scope="col">Indirizzo</th>
                            <th scope="col"><input type="text" name="indirizzo" required></th>
                        </tr>
                        <tr>
                            <th scope="col">Data di nascita</th>
                            <th scope="col"><input type="text" name="nascita" required></th>
                        </tr>
                        <tr>
                            <th scope="col">Note</th>
                            <th scope="col"><input type="text" name="note" required></th>
                        </tr>
                    </thead>

                    <!-- <tfoot>
                     <tr>
                        <td colspan="5">Totale contatti: 100</td>
                    </tr> -->
                    <!-- </tfoot> -->
                </table>
